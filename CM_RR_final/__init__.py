...
def get_quiz_data():
    return [
        dict(
            name='Test_1',
            solution=True,
            explanation="La risposta corretta è: La probabilità con cui le tue previsioni vengono sostituite è 75%",
        ),
        dict(
            name='Test_2',
            solution=True,
            explanation="La risposta corretta è: Vero vi informiamo che i partecipanti che compiono le stesse scelte nella parte 1, "
        ...
        dict(
            ...
            explanation="La risposta corretta è: Vero se esprimi le tue scelte sinceramente e facendo molta attenzione nella parte 1, il "
                        "compenso monetario aggiuntivo che posso ottenere nella parte 2 dipende solo dalle mie previsioni ",
 ...
 #   Test_choices_C_prob =  models.IntegerField(min=0,max=1)
  ...
  #  payoff_C_guess = models.FloatField()
    ...
    Test_4 = models.CharField(
        ...
        widget=widgets.RadioSelectHorizontal,
        label="Quanto pensi che sia credibile la seguente affermazione? I partecipanti che scelgono la "
...
class Instruction_34_2(Page):
    @staticmethod
    def is_displayed(player: Player):
        return  player.participant.accept ==1

class Instruction_34_3(Page):
    @staticmethod
    def is_displayed(player: Player):
        return  player.participant.accept ==1

class Instruction_34_4(Page):
    @staticmethod
    def is_displayed(player: Player):
        return  player.participant.accept ==1
...
class Instruction_40_2(Page):
    ...
    def is_displayed(player: Player):
        return  player.participant.accept ==1
class Instruction_41(Page):
    @staticmethod
    def is_displayed(player: Player):
        return  player.participant.accept ==1
class Instruction_42(Page):
    @staticmethod
    def is_displayed(player: Player):
        return  player.participant.accept ==1
class Instruction_43(Page):
    @staticmethod
    def is_displayed(player: Player):
        return  player.participant.accept ==1
class Instruction_44(Page):
    @staticmethod
    def is_displayed(player: Player):
        return  player.participant.accept ==1
...
class your_payoff_not_replaced(Page):
    ...
    def vars_for_template(player):
        ...
        payoff_b = round(Constants.quadratic_score_A + Constants.quadratic_score_B * (2 * b - factor1), 1)
        payoff_c = round(Constants.quadratic_score_A + Constants.quadratic_score_B * (2 * c - factor1), 1)
        if player.participant.random_choice == 'A':
            player.payoff = payoff_a
        elif player.participant.random_choice == 'B':
            player.payoff = payoff_b
        elif player.participant.random_choice == 'C':
            player.payoff = payoff_c
